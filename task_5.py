...
#Находим количество купюр и монет каждого номинала
...
nominal_1 = (users_amount_of_money - nominal_100*100 - nominal_50*50 - nominal_20*20 - nominal_10*10 - nominal_5*5 
             - nominal_2*2) //1
